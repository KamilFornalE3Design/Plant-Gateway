...
namespace PlantGateway.Application.Pipelines.Validator.Interfaces
{
    ...
    public interface IValidatorStrategy
    {
        ...
        /// </summary>
        ValidatorResult Analyze(IPipelineContract pipeline);
    }
